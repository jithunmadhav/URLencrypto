  ...
  return (
    <div>
      ...
      <div className='inner-div'>
       ...
       <svg style={{ position:'absolute',right:'-10%',top:'-9%' }} xmlns="http://www.w3.org/2000/svg" width="35" height="25" fill="currentColor" class="bi bi-box-arrow-right" viewBox="0 0 16 16">
